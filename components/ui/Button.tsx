    ...
    'object-cover', 
    {
        variants: {
            btnStyle: {
                ...
                boxgen:
                    'bento-outline outline-0 ring-1 ring-zinc-200 dark:ring-[#1a1a1a] p-1 hover:bg-white dark:hover:bg-neutral-900/90 dark:hover:ring-neutral-800',
            },
        },
    defaultVariants: {
        btnStyle: 'solid',
...
export function Button({ className = '', btnStyle, href, ...props }: ButtonProps) {
    className = `inline-flex items-center gap-2 justify-center overflow-hidden rounded-md text-sm outline-offset-2 transition active:transition-none 
