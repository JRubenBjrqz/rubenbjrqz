    ...
    <>
      <Container>
        <div className="grid grid-cols-10 grid-rows-6 gap-7 p-5 lg:min-h-[52rem]">
          <div className="relative col-span-10 h-44 border border-red-500 md:h-56 md:col-span-5 lg:h-auto lg:col-span-4 lg:row-span-4">
            {/* About */}
          </div>
          <div className="relative col-span-10 border border-blue-500 md:col-span-5 lg:col-span-6 lg:row-span-2">
            {/* Work Experience */}
          </div>
