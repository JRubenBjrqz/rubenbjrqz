...
export default function Home() {
  return (
    <>
      <Container>
        <div className="grid grid-cols-10 md:grid-rows-6 gap-7 p-5 lg:min-h-[52rem]">
          <About className="relative col-span-10 h-full md:h-56 md:col-span-5 lg:h-auto lg:col-span-4 lg:row-span-4" />
          <Resume className="relative col-span-10 md:col-span-5 lg:col-span-6 lg:row-span-2" />
          <Stack className="relative col-span-10 h-60 md:h-full md:col-span-5 lg:col-span-3 lg:row-span-2" />
